...
import com.android.androidcourseretrofit.databinding.ActivityMainBinding
    ...
    fun showPosts(){
        ...
        call.enqueue(object : Callback<List<Posts>>{
            override fun onResponse(
                ...
                mainBinding.textViewUserId.text = postList[1].userId.toString()
                mainBinding.textViewId.text = postList[1].id.toString()
                mainBinding.textViewTitle.text = postList[1].title.toString()
                mainBinding.textViewBody.text = postList[1].subTitle.toString()
            }
